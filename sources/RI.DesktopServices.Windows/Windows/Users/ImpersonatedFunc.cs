...
namespace RI.DesktopServices.Windows.Users
{
    ...
    /// The return value.
    /// </returns>
    public delegate TResult ImpersonatedFunc<out TResult> (IntPtr token, WindowsIdentity identity, WindowsUserProfile profile);
    ...
    /// The return value.
    /// </returns>
    public delegate Task<TResult> ImpersonatedFuncAsync<TResult> (IntPtr token, WindowsIdentity identity, WindowsUserProfile profile);
}
