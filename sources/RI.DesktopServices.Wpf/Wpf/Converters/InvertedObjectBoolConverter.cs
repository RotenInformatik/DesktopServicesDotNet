...
namespace RI.DesktopServices.Wpf.Converters
{
    ...
    /// <remarks>
    ///     <para>
    ///         <see cref="InvertedObjectBoolConverter" /> is used when a reference value of any type needs to be used as
    ///         boolean value.
    ///     </para>
    ///     <para>
    ...
    public sealed class InvertedObjectBoolConverter : IValueConverter
    {
        ...
        public object ConvertBack (object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return (bool)value ? null : (parameter is IEnumerable ? ((IEnumerable)parameter).Cast<object>()
