...
namespace RI.DesktopServices.Settings
{
    ...
    ///         However, the values written to and loaded from a storage are strings. The storage is responsible to convert them into the format used by the storage.
    ///     </para>
    /// <para>
    /// The conversion from/to strings used by the storages is done using converters (implementing <see cref="ISettingConverter"/>).
    ...
    ///         Values are persisted with all available non-read-only storages and therefore are saved multiple times if multiple non-read-only storages are available.
    ///     </para>
    ///     <para>
    ///         When values are filtered based on their names using <see cref="ISettingStorage.WriteOnlyKnown" />. In such cases, a storage only writes values whose names are already available in the storage.
    ///     </para>
    ///     <para>
    ///         When values are filtered based on their names using <see cref="ISettingStorage.WritePrefixAffinities" />. In such cases, a storage only writes values whose names start with the specified prefix.
    ///     </para>
    ///     <para>
    ...
    ///     </para>
    /// </remarks>
    /// TODO: What if multiple converter support the same type?
    public interface ISettingService
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name" /> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="name" /> is an empty string. </exception>
        /// <exception cref="InvalidOperationException"> The specified <typeparamref name="T" /> for <paramref name="defaultValue" /> is not supported by any setting converter. </exception>
        ...
        /// <exception cref="ArgumentException"> <paramref name="name" /> is an empty string. </exception>
        /// <exception cref="InvalidOperationException"> The specified <paramref name="type" /> for <paramref name="defaultValue" /> is not supported by any setting converter. </exception>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name" /> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="name" /> is an empty string. </exception>
        /// <exception cref="InvalidOperationException"> The specified <typeparamref name="T" /> for <paramref name="defaultValues" /> is not supported by any setting converter. </exception>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name" /> or <paramref name="type" /> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="name" /> is an empty string. </exception>
        /// <exception cref="InvalidOperationException"> The specified <paramref name="type" /> for <paramref name="defaultValues" /> is not supported by any setting converter. </exception>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name" /> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="name" /> is an empty string. </exception>
        /// <exception cref="InvalidOperationException"> The specified <typeparamref name="T" /> is not supported by any setting converter. </exception>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name" /> or <paramref name="type" /> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="name" /> is an empty string. </exception>
        /// <exception cref="InvalidOperationException"> The specified <paramref name="type" /> is not supported by any setting converter. </exception>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name" /> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="name" /> is an empty string. </exception>
        /// <exception cref="InvalidOperationException"> The specified <typeparamref name="T" /> for <paramref name="value" /> is not supported by any setting converter. </exception>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name" /> or <paramref name="type" /> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="name" /> is an empty string. </exception>
        /// <exception cref="InvalidOperationException"> The specified <paramref name="type" /> for <paramref name="value" /> is not supported by any setting converter. </exception>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name" /> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="name" /> is an empty string. </exception>
        /// <exception cref="InvalidOperationException"> The specified <typeparamref name="T" /> for <paramref name="values" /> is not supported by any setting converter. </exception>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name" /> or <paramref name="type" /> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="name" /> is an empty string. </exception>
        /// <exception cref="InvalidOperationException"> The specified <paramref name="type" /> for <paramref name="values" /> is not supported by any setting converter. </exception>
