...
namespace RI.DesktopServices.UiContainer
{
    ...
    public interface IRegionAdapter
    {
        ...
        /// <remarks>
        ///     <note type="note">
        ///         Do not call this method directly, it is intended to be called from an <see cref="IRegionService" />
        ///         implementation.
        ///     </note>
        /// </remarks>
        /// <exception cref="ArgumentNullException"> <paramref name="container" /> or <paramref name="element" /> is null. </exception>
        /// <exception cref="NotSupportedException">
        ///     The type of <paramref name="container" /> or <paramref name="element" /> is
        ///     not supported by this region adapter or <paramref name="container" /> already has an element and does not support
        ///     multiple elements.
        /// </exception>
        ...
        ///         leaving the container without an element.
        ///     </para>
        ///     <note type="note">
        ///         Do not call this method directly, it is intended to be called from an <see cref="IRegionService" />
        ///         implementation.
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="container" /> is null. </exception>
        /// <exception cref="NotSupportedException">
        ///     The type of <paramref name="container" /> is not supported by this region
        ///     adapter.
        /// </exception>
        ...
        /// <exception cref="NotSupportedException">
        ///     The type of <paramref name="container" /> or <paramref name="element" /> is
        ///     not supported by this region adapter.
        /// </exception>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="container" /> is null. </exception>
        /// <exception cref="NotSupportedException">
        ///     The type of <paramref name="container" /> is not handled by this region
        ///     adapter.
        /// </exception>
