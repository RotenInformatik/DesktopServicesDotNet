...
namespace RI.DesktopServices.UiContainer
{
    ...
    ///         This allows application modules to implement their own user interface without any dependency to the overall user interface structure.
    ///     </para>
    ///     <para>
    ///         Each region is represented by a container into which elements are inserted.
    ///         The region service uses <see cref="IRegionAdapter" /> to do the mapping between the containers and elements so they do not have a dependency on each other.
    ...
    public interface IRegionService
    {
        ...
        /// <exception cref="NotSupportedException"> The type of <paramref region="container" /> is not supported by any region adapter. </exception>
        ...
        /// <remarks>
        ///     <para>
        ///         <paramref name="element" /> can be null to only navigate away from the current element but not to a new one, leaving the region without an navigated to element.
        ///     </para>
        /// </remarks>
        /// <exception cref="ArgumentNullException"> <paramref name="region" /> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="region" /> is an empty string. </exception>
